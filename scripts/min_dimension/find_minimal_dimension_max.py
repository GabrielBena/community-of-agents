...
if __name__ == "__main__": 
    ...
    dual_r = config['model_params']['agents_params']['dual_readout']
    need_dual_r = (config['training']['decision_params'] == '0' and config['task'] == 'none')

    assert (need_dual_r and dual_r)  or (not need_dual_r and not dual_r)
